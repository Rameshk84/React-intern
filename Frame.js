...
const Frame = () => {
  return (
    <div className="frame">
      ...
      <img className="download-6-icon" alt="" src="/download-6@2x.png" />
      <div className="show-more">Show more</div>
      <div className="div">9.3</div>
      ...
      <div className="div2">$39.96</div>
      <div className="div3">$49.96</div>
      ...
      <img className="image-icon6" alt="" src="/.svg" />
      ...
      <img className="image-icon11" alt="" src="/image.svg" />
      <div className="image9" />
      <img className="image-icon12" alt="" src="/image.svg" />
      <div className="image10" />
      <img className="image-icon13" alt="" src="/image.svg" />
      <div className="image11" />
      <div className="rectangle172" />
      <img className="image-icon14" alt="" src="/image.svg" />
      ...
      <img className="image-icon16" alt="" src="/image.svg" />
      ...
      <div className="component-1">
        ...
        <img className="image-icon17" alt="" src="/image.svg" />
        <div className="categories">Categories</div>
        <div className="website-builders">Website Builders</div>
      </div>
      <div className="todays-deals">Today's deals</div>
      <div className="best-website-builders">
        Best Website builders in the US
      </div>
      <div className="advertising-disclosure">Advertising Disclosure</div>
      <div className="last-updated">Last Updated</div>
      <div className="div4">-</div>
      <div className="february-22-2020">February 22, 2020</div>
      <div className="top-relevant">Top Relevant</div>
      <div className="tools">Tools</div>
      <div className="aws-builder">AWS Builder</div>
      <div className="start-build">Start Build</div>
      <div className="build-supplies">Build Supplies</div>
      <div className="tooling">Tooling</div>
      <div className="bluehosting">BlueHosting</div>
      <div className="home">Home</div>
      <div className="hosting-for-all">Hosting for all</div>
      ...
      <div className="builder-11">Builder 1</div>
      ...
      <div className="what-you-get1">
        [What You Get]: Receive the WixPro website builder suite, access to
        premium design templates, an extensive library of widgets and apps, and
        detailed step-by-step guides.
      </div>
      <img className="download-1-icon" alt="" src="/download-6@2x.png" />
      <div className="show-more1">Show more</div>
      <div className="div6">9.8</div>
      ...
      <div className="sitecraft-68-inch-ultimate-container">
      ...
      <div className="what-you-get2">
        [What You Get]: Gain access to the SiteCraft design studio, featuring a
        robust selection of design elements, SEO optimization tools, and
        e-commerce integrations.
      </div>
      <div className="show-more2">Show more</div>
      <div className="div8">9.5</div>
      <div className="excellent">Excellent</div>
      <div className="view2">
        <p className="view3">View</p>
      </div>
      <div className="related-deals-you">Related deals you might like for</div>
      <div className="sign-up-and">Sign up and get exclusive special deals</div>
      <div className="sign-up">Sign Up</div>
      <div className="categories1">Categories</div>
      <div className="web-builder">Web Builder</div>
      <div className="hosting1">Hosting</div>
      <div className="data-center">Data Center</div>
      <div className="robotic-automation">Robotic-Automation</div>
      ...
      <img className="image-icon18" alt="" src="/image.svg" />
      <div className="rectangle272" />
      <div className="rectangle273" />
      <img className="image-icon19" alt="" src="/image.svg" />
      <div className="rectangle274" />
      <div className="rectangle275" />
      <img className="image-icon20" alt="" src="/image.svg" />
      <div className="rectangle276" />
      <div className="rectangle277" />
      <div className="rectangle278" />
      <div className="rectangle279" />
      <div className="rectangle280" />
      <div className="rectangle281" />
      <div className="rectangle282" />
      <div className="rectangle283" />
      <div className="rectangle284" />
      <img className="image-icon21" alt="" src="/image.svg" />
      <div className="rectangle285" />
      <div className="rectangle286" />
      ...
      <div className="off2">26% Off</div>
      <div className="div9">9.9</div>
      <div className="building-responsive">building responsive</div>
      <div className="div10">8.9</div>
      <div className="cool">Cool</div>
      <div className="div11">8.9</div>
      <div className="docs">Docs</div>
      <div className="why-we-love">Why we love it</div>
      <div className="documentation">Documentation</div>
      <div className="easy-use">Easy Use</div>
      <div className="out-of-box">Out of box</div>
      <div className="show-more3">Show more</div>
      <div className="very-good">Very Good</div>
      <div className="view4">View</div>
      <div className="div12">9.1</div>
      <img className="download-2-icon" alt="" src="/download-6@2x.png" />
      <img className="download-3-icon" alt="" src="/download-6@2x.png" />
      <div className="rectangle287" />
      <div className="rectangle288" />
      <div className="rectangle288" />
      <div className="rectangle290" />
      <div className="rectangle291" />
      <div className="image18" />
      <div className="rectangle292" />
      <div className="rectangle292" />
      <div className="rectangle293" />
      <div className="rectangle294" />
      <div className="rectangle295" />
      <div className="rectangle296" />
      <div className="rectangle297" />
      <div className="rectangle298" />
      <div className="rectangle299" />
      <div className="rectangle300" />
      <div className="rectangle301" />
      <div className="rectangle302" />
      <div className="rectangle303" />
      <div className="rectangle304" />
      <div className="rectangle305" />
      <div className="rectangle306" />
      <div className="rectangle307" />
      <div className="rectangle308" />
      <div className="rectangle309" />
      <div className="rectangle310" />
      <div className="off3">20% Off</div>
      <div className="limited-time1">{`Limited time `}</div>
      <b className="webbuilder-11">Webbuilder 1</b>
      <div className="div13">$39.96</div>
      <div className="div14">$49.96</div>
      <div className="off4">(20% Off)</div>
      <div className="view-deal1">View Deal</div>
      <div className="computer-modern-clasic1">
        Computer Modern clasic with wix support
      </div>
      <img className="download-4-icon" alt="" src="/download-6@2x.png" />
      <div className="rectangle311" />
      <div className="rectangle312" />
      <div className="rectangle312" />
      <div className="rectangle314" />
      <div className="rectangle315" />
      <div className="image20" />
      <div className="rectangle316" />
      <div className="rectangle316" />
      <div className="rectangle317" />
      <div className="rectangle318" />
      <div className="rectangle319" />
      <div className="rectangle320" />
      <div className="rectangle321" />
      <div className="rectangle322" />
      <div className="rectangle323" />
      <div className="rectangle324" />
      <div className="rectangle325" />
      <div className="rectangle326" />
      <div className="rectangle327" />
      <div className="rectangle328" />
      ...
      <div className="rectangle334" />
      <div className="off5">20% Off</div>
      <div className="limited-time2">{`Limited time `}</div>
      <b className="webbuilder-12">Webbuilder 1</b>
      <div className="div15">$39.96</div>
      <div className="div16">$49.96</div>
      <div className="off6">(20% Off)</div>
      <div className="view-deal2">View Deal</div>
      <div className="computer-modern-clasic2">
        Computer Modern clasic with wix support
      </div>
      <img className="download-5-icon" alt="" src="/download-6@2x.png" />
      <div className="rectangle335" />
      <div className="div17">4</div>
      <img className="download-7-icon" alt="" src="/download-6@2x.png" />
      <b className="main-highlights3">Main highlights</b>
    </div>
  );
};
